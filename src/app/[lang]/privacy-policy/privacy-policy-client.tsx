  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#2ee6a6]/70 mb-4">
          {lang === 'en' ? 'Legal' : 'Légal'}
        </p>
        <h1 className="font-heading text-4xl text-white mb-3">{tx.title}</h1>
        ...
        <div className="mt-16 border-t border-white/[0.06] pt-8">
          <a href={href("/")} className="text-sm text-[#2ee6a6]/70 hover:text-[#2ee6a6] transition-colors">
